...
@interface NAMasterViewController () {
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (NADetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
